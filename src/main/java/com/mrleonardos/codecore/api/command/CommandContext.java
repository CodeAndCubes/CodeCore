 ...
 *
 * <p>
 * Ключ перевода в {@link #reply} разбирает сервер и отдаёт готовую строку: язык задаёт ключ
 * {@code language} главного файла линейки, языка клиента сервер не знает. Ключи ошибок разбора
 * аргументов, брошенные исключением игры, переводит клиент: клиентская половина у модов линейки
 * обязательна и несёт файлы перевода с собой.
 */
